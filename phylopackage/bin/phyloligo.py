...
from phylopackage import phylodist
...
unpack_distances = {"JSD": phylodist.JSD,
                    "Eucl": phylodist.Eucl,
                    "KT": phylodist.KT,
                    "BC": phylodist.BC,
                    "SC": phylodist.SC
...
def compute_distances_joblib(frequencies, metric="Eucl", n_jobs=1):
    ...
    distances: np.array
        (n_samples, n_samples) distance matrix
    """
    call_dist = {"Eucl": phylodist.Eucl, "JSD": phylodist.JSD, "KT": phylodist.KT, "BC": 'braycurtis', "SC": phylodist.SC}
